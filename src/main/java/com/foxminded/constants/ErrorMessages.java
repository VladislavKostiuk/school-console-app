...
public final class ErrorMessages {
    ...
    public final static String INCORRECT_DB_PROPERTIES = "Incorrect data base properties";
    public final static String STUDENTS_CANT_BE_NULL = "Student list cant be null";
    public final static String GROUPS_CANT_BE_NULL = "Groups list cant be null";
    public final static String COURSES_CANT_BE_NULL = "Course list cant be null";
    ...
    public final static String STUDENT_NAME_CANT_BE_EMPTY = "Student first or last names can't be null";
